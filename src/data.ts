...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    imageUrl: "/images/portfolio/edilpro-costruzioni.webp",
  ...
  },
  {
    ...
    imageUrl: "/images/portfolio/barber-studio-ticino.webp",
  ...
  },
  {
    ...
    imageUrl: "/images/portfolio/tettopro-ticino.webp",
    ...
    mockupContent: {
      ...
      colors: {
        primary: "#7c8a99", // slate roof grey
        secondary: "#15181c", // dark graphite
        bg: "#0a0b0d",
        text: "#f1f2f4"
      },
      sections: [
        {
          title: "I Nostri Servizi",
          content: "• Rifacimento e manutenzione tetti\n• Impermeabilizzazione coperture\n• Isolamento termico del tetto"
        },
        {
          title: "Sopralluogo Gratuito",
          content: "Valutiamo lo stato del tuo tetto senza impegno e proponiamo la soluzione più adatta."
        }
      ],
