...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 sm:py-24 lg:py-32 bg-dark-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10 w-full">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            {viewMode === "slider" && (
              <button
                ...
                className="p-2.5 rounded-xl bg-zinc-950 border border-zinc-900 text-zinc-500 hover:text-zinc-300 transition-colors cursor-pointer flex items-center justify-center"
        ...
        <AnimatePresence mode="wait">
          ...
          {viewMode === "slider" && (
            ...
            >
              ...
              <div 
                className="relative min-h-[380px] sm:min-h-[420px] lg:min-h-[340px] rounded-3xl p-px bg-gradient-to-b from-zinc-800 to-zinc-900 flex flex-col justify-center overflow-hidden shadow-2xl"
              ...
              >
                ...
                <div className="relative z-10 p-6 sm:p-10 lg:p-12 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center text-left">
          ...
          {viewMode === "grid" && (
            ...
            >
              {premiumTestimonials.map((t, index) => (
                <motion.div
                  key={t.id}
                  ...
                  className="p-px rounded-3xl bg-zinc-900 border border-white/5 bg-gradient-to-b from-zinc-800/80 to-zinc-950 flex flex-col justify-between overflow-hidden shadow-xl group hover:border-gold-500/20 transition-all duration-300"
                >
                  <div className="bg-[#0b0b0e] h-full p-6 sm:p-8 flex flex-col justify-between rounded-[22px]">
                    ...
                    <div className="pt-6 mt-6 border-t border-zinc-900/60 text-left space-y-4">
                      ...
                      <div className="flex items-center justify-between p-2.5 rounded-xl bg-zinc-950 border border-zinc-900">
                        <span className="text-[9px] font-mono text-zinc-500 font-bold uppercase tracking-wider">{language === "it" ? "Risultato" : "Outcome"}:</span>
        ...
        <div className="mt-20 p-6 sm:p-8 rounded-3xl border border-zinc-900/80 bg-zinc-950/50 backdrop-blur-md grid grid-cols-1 md:grid-cols-3 gap-6 text-left relative overflow-hidden">
          {/* Accent decoration */}
