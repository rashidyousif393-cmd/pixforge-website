...
export default function Pricing() {
  ...
  return (
    <section id="listino" className="py-20 sm:py-24 lg:py-32 bg-[#08080a] relative overflow-hidden w-full">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-950 border border-zinc-800/80 text-gold-500 font-mono text-xs uppercase tracking-widest font-semibold">
              ...
              {pricingPlans.map((plan, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative rounded-3xl flex flex-col justify-between overflow-hidden transition-all duration-500 group ${
                      isProfessional
                        ? "p-[1.5px] bg-gradient-to-b from-gold-500 via-amber-400 to-gold-600 shadow-[0_15px_45px_rgba(212,175,55,0.15)] scale-103 z-20"
                        : "p-px bg-zinc-800/80 hover:bg-zinc-700/80 shadow-[0_10px_30px_rgba(0,0,0,0.3)] z-10"
                    }`}
                  >
                    ...
                    <div className="bg-[#0b0b0e] h-full rounded-[22px] p-7 sm:p-9 flex flex-col justify-between relative z-10">
                  ...
                  <thead>
                    <tr className="border-b border-zinc-900 bg-zinc-950">
                      ...
                      <th className="p-6 text-center w-1/4">
                        <span className="text-[9px] font-mono font-bold text-zinc-500 uppercase tracking-widest block mb-1">STANDARD</span>
                      ...
                      <th className="p-6 text-center w-1/4">
                        <span className="text-[9px] font-mono font-bold text-zinc-500 uppercase tracking-widest block mb-1">PRESTIGE</span>
        ...
        <div className="relative rounded-3xl p-[1.5px] bg-gradient-to-r from-zinc-800 via-zinc-700 to-zinc-800 shadow-2xl overflow-hidden w-full">
                ...
                <div className="p-6 sm:p-8 rounded-2xl bg-zinc-950 border border-zinc-900/80 flex flex-col justify-between h-full space-y-6 shadow-2xl">
                  <div className="text-center space-y-2">
                    ...
                    <div className="inline-flex items-baseline gap-1.5 py-1">
                      <span className="text-xs font-bold text-zinc-500 font-mono">CHF</span>
                      <span className="text-4xl sm:text-5xl font-display font-black text-white tracking-tight">
