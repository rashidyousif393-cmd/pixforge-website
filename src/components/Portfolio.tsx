...
const getProjectArticleInItalian = (projectId: string, projectTitle: string, category: string, location: string): string => {
  switch (projectId) {
    ...
    case "construction":
      return "Edilizia Alpina SA è una solida e rinomata impresa edile attiva nel Mendrisiotto, specializzata in ristrutturazioni chiavi in mano, nuove costruzioni civili e industriali con un focus costante sulla precisione svizzera e l'edilizia sostenibile (certificazioni Minergie). L'azienda necessitava di un portale aziendale che potesse testimoniare concretamente l'eccellenza dei propri lavori realizzati nel Canton Ticino, in quanto la vecchia presenza web non offriva alcuna prova visiva o referenza strutturata. PixelForge ha creato una piattaforma aziendale imponente ed elegante, caratterizzata da linee geometriche pulite e da un portfolio progetti filtrabile e ad altissima risoluzione. Abbiamo inoltre integrato un sistema avanzato di richiesta preventivi online e una sezione dedicata alle opportunità di carriera. L'architettura visiva del sito si basa su una griglia geometrica rigorosa che riflette i valori di stabilità, ordine e sicurezza costruttiva propri del marchio. Abbiamo implementato un sistema di caricamento asincrono delle schede tecniche di progetto, che consente a architetti e ingegneri di scaricare planimetrie e capitolati d'appalto in formato PDF in modo istantaneo. La sezione 'Prima e Dopo' interattiva permette di visualizzare la complessità tecnica e l'eleganza estetica dei lavori di recupero storico svolti in tutto il Cantone. Grazie a questo restyling tecnologico di qualità superiore, le richieste di preventivo per ristrutturazioni complesse e nuove opere residenziali sono aumentate del 50%, conferendo all'azienda un vantaggio competitivo cruciale nelle gare d'appalto pubbliche e private in tutto il Canton Ticino e posizionandola come leader indiscusso nell'edilizia di alta precisione. Il portale ha inoltre migliorato l'acquisizione di personale qualificato ticinese grazie a un'area recruitment automatizzata e performante, riducendo i tempi di selezione del personale tecnico del 40%. Questo approccio integrato ha trasformato la reputazione online di Edilizia Alpina da semplice impresa edile locale a player di riferimento per progetti architettonici ambiziosi di livello cantonale.";
    case "medical":
      return "Il Centro Medico San Rocco è un polo sanitario multidisciplinare all'avanguardia situato a Chiasso, dedicato a offrire cure specialistiche, diagnostica rapida e terapie riabilitative di alta qualità. La clinica riscontrava grandi difficoltà nel comunicare con chiarezza ai cittadini l'ampia gamma di specializzazioni disponibili e la segreteria era spesso congestionata da chiamate per informazioni stradali o orari. PixelForge ha sviluppato una web app totalmente accessibile, sicura e in assoluta conformità con le leggi svizzere sulla protezione dei dati sanitari (DSG). Abbiamo strutturato un design pulito, focalizzato sulla leggibilità, che include una mappa interattiva per facilitare il raggiungimento della sede tramite mezzi pubblici o auto. L'architettura delle informazioni è stata progettata seguendo le linee guida di accessibilità WCAG, garantendo un contrasto cromatico ottimale e la piena compatibilità con lettori di schermo per non vedenti o ipovedenti. Abbiamo implementato un database dinamico e sicuro per la consultazione degli orari e delle disponibilità dei diversi medici specialisti in tempo reale. Inoltre, il sistema di prenotazione appuntamenti asincrono è stato protetto tramite crittografia end-to-end, assicurando la riservatezza assoluta delle informazioni personali e mediche inviate dai pazienti. Grazie al modulo integrato per la richiesta di appuntamenti specialistici online, l'afflusso di nuovi pazienti è cresciuto in modo esponenziale, riducendo i tempi di attesa telefonici per gli utenti del 45%, migliorando notevolmente l'efficienza della pianificazione interna della clinica e innalzando la soddisfazione complessiva dell'utenza locale. L'introduzione della sezione informativa sulla prevenzione sanitaria ha inoltre posizionato il centro come autorevole punto di riferimento per l'educazione alla salute nel Mendrisiotto, registrando oltre diecimila consultazioni mensili uniche e rafforzando il legame di fiducia con la comunità del territorio.";
    case "realestate":
    ...
    case "winery":
      return "Tenuta dell'Oro rappresenta un'eccellenza vinicola senza compromessi nel cuore del Mendrisiotto, una regione svizzera celebre per i suoi terreni generosi e il suo straordinario microclima favorevole alla coltivazione del Merlot. Prima dell'intervento strategico di PixelForge, la cantina affrontava una problematica estremamente comune nel settore vinicolo tradicional: la totale dipendenza dai canali di distribuzione fisici offline e l'impossibilità, per gli amanti del vino internazionali e i ristoratori d'élite sparsi per la Confederazione, di acquistare le preziose bottiglie DOC direttamente online in modo rapido e sicuro. Inoltre, la gestione delle visite guidate e delle esclusive sessioni di degustazione in cantina avveniva tramite processi manuali cartacei o scambi prolungati di e-mail, creando barriere all'acquisto e sovraccaricando la segreteria aziendale. PixelForge ha rivoluzionato la presenza digitale di Tenuta dell'Oro realizzando un portale e-commerce premium dal design immersivo e raffinato, caratterizzato da tonalità calde e dorate abbinate a un profondo bordeaux che rievoca i toni regali del vino affinato in botte. Abbiamo progettato uno storytelling digitale affascinante che guida l'utente alla scoperta della storia dei vigneti storici della famiglia dell'Oro e del rigoroso rispetto per la natura che contraddistingue ogni fase della vendemmia manuale. La caratteristica chiave del nuovo portale è l'integrazione di un sistema di prenotazione in tempo reale delle degustazioni e dei percorsi storici guidati nei vigneti, che permette agli utenti di selezionare date, orari ed esperienze personalizzate direttamente dallo smartphone, effettuando il pagamento sicuro in un clic. I risultati ottenuti sono stati sensazionali: in soli tre mesi dal lancio, le vendite dirette online di vini pregiati e riserve DOC sono aumentate del 65%, riducendo i costi di intermediazione e massimizzando i margini commerciali. Inoltre, le prenotazioni delle degustazioni guidate hanno registrato il tutto esaurito con un orizzonte di pianificazione di oltre tre mesi, consolidando la reputazione della cantina come meta enogastronomica di riferimento assoluto a livello nazionale e internazionale.";
    case "architect":
...
export default function Portfolio() {
  ...
  const categories = [
    ...
    { id: "medical", label: language === "it" ? "Medicina" : "Medical", industry: language === "it" ? "Centro Medico" : "Medical Center" },
    ...
    { id: "winery", label: language === "it" ? "Cantina" : "Winery", industry: language === "it" ? "Cantina Vinicola" : "Winery & Vineyards" },
  ...
  const getProjectTechnologies = (projectId: string): string[] => {
    switch (projectId) {
      ...
      case "medical":
        return ["React 19", "Tailwind CSS", "Accessibility Suite", "Form API", "ÖV Location Router"];
      case "realestate":
      ...
      case "winery":
        return ["React 19", "Tailwind CSS", "Stripe E-commerce", "Interactive Wine Tour", "WhatsApp Support"];
      case "architect":
  ...
  const getBeforeAfterMetrics = (projectId: string) => {
    switch (projectId) {
      ...
      case "construction":
        return {
          before: { speed: "5.9s", conversion: "1.0%", bounce: "68%", label: language === "it" ? "Senza referenze o portfolio" : "No Project References" },
          after: { speed: "0.4s", conversion: "4.2%", bounce: "19%", label: "PixelForge Premium" }
        };
      case "medical":
        return {
          before: { speed: "4.5s", conversion: "0.9%", bounce: "58%", label: language === "it" ? "Illeggibile da smartphone" : "Hard to read on mobile" },
          after: { speed: "0.3s", conversion: "3.5%", bounce: "11%", label: "PixelForge Premium" }
        };
      case "realestate":
        return {
      ...
      case "winery":
        return {
          before: { speed: "6.4s", conversion: "1.1%", bounce: "75%", label: language === "it" ? "Vecchio sito statico" : "Old Static Site" },
          after: { speed: "0.2s", conversion: "4.9%", bounce: "13%", label: "PixelForge Premium" }
        };
      case "architect":
        return {
  ...
  const getProjectObjectives = (projectId: string): string[] => {
    switch (projectId) {
      ...
      case "construction":
        return language === "it"
          ? ["Mostrare le referenze e i progetti realizzati in Ticino", "Fornire un modulo preventivo rapido e intuitivo", "Trasmettere solidità, precisione e qualità svizzera"]
          : ["Display physical construction credentials in Ticino", "Offer an intuitive custom estimation form", "Communicate structural stability, rigor, and Swiss quality"];
      case "medical":
        return language === "it"
          ? ["Fornire un'interfaccia accessibile a pazienti di ogni età", "Facilitare la prenotazione delle visite specialistiche", "Garantire la conformità totale alla legge federale DSG"]
          : ["Provide highly accessible UI for patients of all ages", "Enable swift medical specialist appointment requests", "Ensure absolute compliance with Swiss Federal DPA laws"];
      case "realestate":
        return language === "it"
      ...
      case "winery":
        return language === "it"
          ? ["Sviluppo di un e-commerce d'élite per la vendita di Merlot", "Automazione delle prenotazioni per degustazioni guidate", "Storytelling digitale per valorizzare la tradizione di Mendrisio"]
          : ["Develop custom e-commerce engine for direct Merlot sales", "Automate guided wine-tasting reservations", "Craft historical storytelling showcasing Mendrisiotto heritage"];
      case "architect":
        return language === "it"
  ...
  const getProjectResults = (projectId: string): string[] => {
    switch (projectId) {
      ...
      case "construction":
        return language === "it"
          ? ["+50% di richieste di preventivo qualificate tramite il modulo online", "Portfolio utilizzato con successo per gare d'appalto pubbliche", "Visualizzazione fluida di oltre 40 grandi opere realizzate"]
          : ["50% surge in highly qualified custom commercial bids received", "Portfolio utilized to secure key public and private tenders", "Perfect touch responsive presentation of 40+ main assets"];
      case "medical":
        return language === "it"
          ? ["Navigazione facilitata per pazienti anziani e zero reclami", "+45% di richieste appuntamento inviate in modo asincrono", "Piena conformità legale senza alcun rischio sanzionatorio o data breach"]
          : ["Seamless accessibility with zero accessibility complaints", "+45% in medical specialist requests sent digitally", "Absolute peace of mind under the Swiss Federal DPA requirements"];
      case "realestate":
        return language === "it"
      ...
      case "winery":
        return language === "it"
          ? ["+65% di vendite dirette online senza intermediari distributivi", "Degustazioni in vigneto prenotate con 3 mesi di anticipo", "Posizionamento digitale d'eccellenza per gli amanti del Merlot DOC"]
          : ["+65% direct-to-consumer e-commerce wine sales achieved", "Vineyard tastings fully booked out for the next 90 days", "Premium digital footprint recognized by DOC wine experts across CH"];
      case "architect":
        return language === "it"
    ...
    switch (projectId) {
      ...
      case "construction":
        return [
          ...
          "https://images.unsplash.com/photo-1503387762-592deb58ef4e?fm=webp&auto=format&fit=crop&w=400&q=60"
        ];
      case "medical":
        return [
          "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?fm=webp&auto=format&fit=crop&w=400&q=60",
          "https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?fm=webp&auto=format&fit=crop&w=400&q=60",
          "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?fm=webp&auto=format&fit=crop&w=400&q=60"
        ];
      case "realestate":
        return [
      ...
      case "winery":
        return [
          "https://images.unsplash.com/photo-1528825871115-3581a5387919?fm=webp&auto=format&fit=crop&w=400&q=60",
          "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?fm=webp&auto=format&fit=crop&w=400&q=60",
          "https://images.unsplash.com/photo-1560493676-04071c5f4b52?fm=webp&auto=format&fit=crop&w=400&q=60"
        ];
      case "architect":
        return [
  ...
  return (
    <section id="portfolio" className="py-20 sm:py-24 lg:py-32 bg-dark-accent relative overflow-hidden">
      {/* Background radial glow */}
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] rounded-full radial-glow-gold opacity-10 pointer-events-none blur-3xl" />
      <div className="absolute bottom-1/4 left-0 w-[500px] h-[500px] rounded-full radial-glow-blue opacity-10 pointer-events-none blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Categories Tab Bar */}
        <div className="flex flex-wrap items-center justify-center gap-2.5 max-w-5xl mx-auto mb-16 p-2 rounded-2xl bg-zinc-950/65 border border-zinc-900 backdrop-blur-md">
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-gradient-to-r from-gold-500 to-amber-500 rounded-xl"
                    transition={{ type: "spring", stiffness: 350, damping: 30 }}
                  />
                )}
                <span className="relative z-10 block">{cat.label}</span>
                <span className={`relative z-10 text-[9px] block font-mono font-normal opacity-70 ${isActive ? "text-dark-bg" : "text-zinc-500"}`}>
                  {cat.industry}
                </span>
              </button>
            );
        ...
        {portfolioView === "gallery" ? (
          /* NEW GALLERIA PROFESSIONALE GRID WITH MODERN ANIMATIONS */
          <div className="space-y-12">
            ...
            >
              <AnimatePresence mode="popLayout">
                {(activeCategory === "all" ? projectList : projectList.filter(p => p.id === activeCategory)).map((project) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group relative flex flex-col justify-between bg-zinc-950/80 border border-zinc-900 rounded-3xl overflow-hidden shadow-xl hover:border-gold-500/30 hover:shadow-2xl hover:shadow-gold-500/5 transition-all duration-500 cursor-pointer"
                    >
                      {/* Image Container with Zoom and Badge */}
                      <div className="relative h-56 sm:h-60 w-full overflow-hidden border-b border-zinc-900/50">
                        <img
                          src={project.imageUrl}
                          srcSet={getSrcSet(project.imageUrl)}
                        ...
                        {/* Top Location Badge */}
                        <div className="absolute top-4 left-4 px-2.5 py-1 bg-black/75 border border-zinc-800 rounded-lg backdrop-blur-md flex items-center gap-1 z-10">
                        ...
                        {/* Top Trust Badge */}
                        <div className="absolute top-4 right-4 px-2.5 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-lg backdrop-blur-md flex items-center gap-1 text-emerald-400 z-10">
                        ...
                        {/* Floating overlay details on hover */}
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                          <span className="text-[10px] font-mono font-bold text-gold-400 uppercase tracking-widest flex items-center gap-1.5 bg-[#0a0a0c]/90 px-3 py-1.5 border border-zinc-800 rounded-xl backdrop-blur-sm shadow-md">
                      ...
                      <div className="p-6 flex-1 flex flex-col justify-between space-y-5">
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="px-2.5 py-1 bg-gold-500/10 border border-gold-500/20 rounded-lg text-[9px] font-mono font-bold text-gold-400 uppercase tracking-wider">
                              {project.category}
                            </span>
                            <span className="text-[9px] font-mono text-zinc-500 font-bold uppercase tracking-wider bg-zinc-900 border border-zinc-800 px-1.5 py-0.5 rounded">
                              {project.id === "beauty" || project.id === "hotel" || project.id === "fitness" ? (language === "it" ? "3 Settimane" : "3 Weeks") : project.id === "restaurant" ? (language === "it" ? "2 Settimane" : "2 Weeks") : (language === "it" ? "4 Settimane" : "4 Weeks")}
                            </span>
                          </div>
                          
                          <h3 className="font-display text-xl sm:text-2xl font-extrabold text-zinc-100 group-hover:text-gold-400 transition-colors text-left leading-tight">
                            {project.title}
                          </h3>
                          <p className="font-sans text-xs sm:text-sm text-zinc-400 font-light leading-relaxed text-left line-clamp-3">
                            {project.description}
                          </p>
                        </div>

                        {/* Hard Performance KPI Metrics Grid */}
                        <div className="grid grid-cols-2 gap-2.5 p-3.5 bg-[#09090b] border border-zinc-900/60 rounded-2xl">
                          <div className="text-left space-y-0.5">
                            <span className="text-[8px] font-mono font-bold text-zinc-500 uppercase tracking-wider block">{language === "it" ? "VELOCITÀ" : "SPEED"}</span>
                          ...
                          <div className="text-left space-y-0.5 border-l border-zinc-900 pl-3">
                            <span className="text-[8px] font-mono font-bold text-zinc-500 uppercase tracking-wider block">{language === "it" ? "CONVERSIONI" : "CONVERSIONS"}</span>
                            <span className="text-xs font-mono font-extrabold text-emerald-400 flex items-center gap-1">
                        ...
                        {/* Mini features list */}
                        <div className="space-y-1.5 border-t border-zinc-900 pt-3.5 text-left">
                        ...
                        {/* Button */}
                        <button className="w-full py-3 px-4 bg-zinc-900 hover:bg-gradient-to-r hover:from-gold-500 hover:to-amber-500 text-zinc-300 hover:text-dark-bg text-xs font-bold rounded-xl uppercase tracking-wider transition-all duration-500 flex items-center justify-center gap-1.5 border border-zinc-800 hover:border-transparent cursor-pointer">
                          <span>{language === "it" ? "Leggi Caso Studio" : "Read Case Study"}</span>
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-2.5">
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <span className="text-[10px] font-mono text-zinc-500 tracking-wider flex items-center gap-1 uppercase font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/30">
                <h4 className="text-xs font-mono font-bold text-zinc-500 uppercase tracking-widest mb-1">
          ...
          <div className="lg:col-span-6 w-full sticky top-28 space-y-6">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between border-b pb-2 mb-3 mt-1" style={{ borderBottomColor: `${activeProject.mockupContent.colors.primary}15` }}>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[6px] font-mono text-zinc-500 bg-zinc-850 px-1 py-0.5 rounded">TABLET MODE</span>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between border-b pb-2 mb-3 mt-4" style={{ borderBottomColor: `${activeProject.mockupContent.colors.primary}15` }}>
                        ...
                        <span className="text-[6px] font-mono text-zinc-500 bg-zinc-800 px-1 rounded font-bold">DEMO</span>
                      </div>
            ...
            <p className="text-[10px] text-zinc-500 font-mono tracking-wide text-center">
        ...
        {selectedProject && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setSelectedProject(null)}
                className="absolute top-4 right-4 z-50 p-2.5 bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white rounded-full transition-all cursor-pointer border border-zinc-800 shadow-md flex items-center justify-center"
                aria-label="Chiudi"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 max-h-[85vh] overflow-y-auto">
                ...
                {/* Left Column: Visual Preview & Key Metrics & Objectives (Col-5) */}
                <div className="md:col-span-5 p-6 sm:p-8 bg-zinc-950 border-b md:border-b-0 md:border-r border-zinc-900/80 flex flex-col justify-between space-y-6">
                  ...
                  <div className="space-y-5">
                    <div className="relative h-[220px] sm:h-[260px] w-full rounded-2xl overflow-hidden border border-zinc-900 shadow-lg group">
                      <img
                      ...
                      />
                      <div className="absolute top-3 left-3 px-2.5 py-1 bg-gold-500/10 border border-gold-500/20 rounded-lg backdrop-blur-md">
                    ...
                    <div className="space-y-2.5">
                      <div className="p-3 bg-[#0d0d10] border border-zinc-900 rounded-xl flex items-center justify-between">
                        <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Tempo di sviluppo</span>
                      ...
                      <div className="p-3 bg-[#0d0d10] border border-zinc-900 rounded-xl flex items-center justify-between">
                        <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Garanzia Svizzera</span>
                ...
                <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                  ...
                  <div className="space-y-5 text-left">
                    ...
                    <div className="border-t border-zinc-900 pt-4">
                      <h4 className="text-xs font-mono font-bold text-zinc-500 uppercase tracking-wider mb-2.5">
                    ...
                    {/* Results Achieved */}
                    <div className="space-y-2.5 pt-3 border-t border-zinc-900">
                      <h4 className="text-xs font-mono font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1.5">
                        <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                    ...
                    <div className="space-y-2.5 pt-3 border-t border-zinc-900">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {(selectedProject.id === "beauty" 
                          ...
                          ? ["UI/UX Design Accessibile", "Web App Medico-Sanitaria", "Mappa Sedi Interattiva", "Modulo Appuntamenti Specialistici"]
                          ...
                          ? ["UI/UX Cantine d'Elite", "Piattaforma E-commerce", "Modulo Prenotazione Eventi", "Integrazione Stripe Payments"]
